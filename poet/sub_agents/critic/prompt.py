...
Inputs:
first_draft: (string, mandatory) The poem text generated by the Scribe {scribe_output}.
concept_brief: (string, mandatory) The original 'Spark' from the Muse {muse_output}.
poetic_blueprint: (string, mandatory) The structural 'Blueprint' from the Architect {architect_output}.
...
2.  **Weak Spotting:** Swiftly identify the single most predictable image (cliché) and the single clumsiest line (weak flow/verb).
